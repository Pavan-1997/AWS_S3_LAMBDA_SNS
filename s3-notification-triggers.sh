...
bucket_name="pavan-1997-ultimate-bucket"
lambda_func_name="s3-lambda-function"
role_name="s3-lambda-sns"
email_address="sqlonlinux@gmail.com"
...
LambdaFunctionArn="arn:aws:lambda:us-east-2:$aws_account_id:function:s3-lambda-function"
